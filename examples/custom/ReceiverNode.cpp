...
ReceiverNode::~ReceiverNode() { delete widget_; }

QString ReceiverNode::name() const { return "ReceiverNode"; }

QWidget *ReceiverNode::embeddedWidget() { return widget_; }

bool ReceiverNode::resizable() const { return true; }

QtNodes::NodeValidationState ReceiverNode::validationState() const {
  return validationState_;
}

QString ReceiverNode::validationMessage() const { return validationMessage_; }
